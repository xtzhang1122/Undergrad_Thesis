...
% 		septum_speed_Z_avg
	...
	methods
		...
		function obj = VCG_Calc(varargin)
            ...
            % newly added
            obj.vcg_length_t_pre = curve_length(v_cropped.X, v_cropped.Y, v_cropped.Z, qend, find(v_cropped.X == max(v_cropped.X(qend: end))));
            obj.vcg_length_t_post = obj.vcg_length_t - obj.vcg_length_t_pre;
