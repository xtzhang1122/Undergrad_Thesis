function [score] = lafb_criteria(data)
   ...
   % V1 - any QR
   if adjusted_data.selvester_prep.V1_Q_duration > 0 && adjusted_data.selvester_prep.V1_R_duration
       score = score + 1;
   end
   ...
   % V2
   % any QR
   if adjusted_data.selvester_prep.V2_Q_duration > 0 && adjusted_data.selvester_prep.V2_R_duration
       score = score + 1;
   end
